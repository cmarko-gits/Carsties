...
const orderButtons = [
  ...
  { label: 'Recently added', icon: BsFillStopCircleFill, value: 'new' }, // ✅ bez razmaka
];

const filterButtons = [
  { label: 'Live auctions', icon: GiFlame, value: 'live' }, // ✅ malo slovo
  { label: 'Ending < 6 hours', icon: GiFinishLine, value: 'endingSoon' },
  { label: 'Completed', icon: BsStopwatchFill, value: 'finished' }, // ✅ bez razmaka
];
